...
# hitsc only feeds raw PiKVM H.264 elementary streams into libavcodec, optionally
# using D3D11VA and swscale fallback. Keep the libraries selected by vcpkg
# features, but do not compile FFmpeg's unrelated codec/component zoo.
if(VCPKG_TARGET_IS_WINDOWS AND "avcodec" IN_LIST FEATURES)
    string(APPEND OPTIONS " --disable-everything")
    string(APPEND OPTIONS " --enable-decoder=h264")
    string(APPEND OPTIONS " --enable-parser=h264")
    string(APPEND OPTIONS " --enable-hwaccel=h264_d3d11va")
    string(APPEND OPTIONS " --enable-hwaccel=h264_d3d11va2")
endif()
